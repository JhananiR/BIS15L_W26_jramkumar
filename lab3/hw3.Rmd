...
```{r}
summits <- c(12884, 800, 500, 1000, 500)
```

```{r}
mountains <- tibble(name, height_feet, height_meters, first_climbed, summits)
```
...
```{r}
fatalities <- c(340, 96, 50, 22, 50)
```

```{r}
mountains <- tibble(name, height_feet, height_meters, first_climbed, summits, fatalities)
```
...
mountains <- tibble(name, height_feet, height_meters, first_climbed, summits, fatalities, fatality_rate)
```
